...
function formatLocale(locale3) {
  ...
  function newFormat(specifier, formats2) {
    return function(date2) {
      var string = [], i = -1, j = 0, n = specifier.length, c4, pad2, format2;
      if (!(date2 instanceof Date)) date2 = /* @__PURE__ */ new Date(+date2);
      while (++i < n) {
        if (specifier.charCodeAt(i) === 37) {
          string.push(specifier.slice(j, i));
          if ((pad2 = pads[c4 = specifier.charAt(++i)]) != null) c4 = specifier.charAt(++i);
          else pad2 = c4 === "e" ? " " : "0";
...
function pie_default() {
  var value = identity_default2, sortValues = descending_default, sort2 = null, startAngle = constant_default4(0), endAngle = constant_default4(tau2), padAngle = constant_default4(0);
  function pie(data) {
...
function Symbol2(type, size) {
  ...
  type = typeof type === "function" ? type : constant_default4(type || circle_default);
  ...
  symbol.type = function(_) {
    return arguments.length ? (type = typeof _ === "function" ? _ : constant_default4(_), symbol) : type;
  };
...
function stack_default() {
  ...
  stack.keys = function(_) {
    return arguments.length ? (keys = typeof _ === "function" ? _ : constant_default4(Array.from(_)), stack) : keys;
  };
...
//# sourceMappingURL=chunk-UYAOUFH6.js.map
